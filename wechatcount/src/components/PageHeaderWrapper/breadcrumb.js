...
const itemRender = (route, params, routes) => {
    ...
    // console.log('wqwewewqe', routes.indexOf(route), routes.length - 1, last, routes, route, paths);
    return last ? (
...
export const conversionBreadcrumbList = (props) => {
    ...
    if (routerLocation && routerLocation.pathname) {
        // console.log('ssss', conversionFromLocation(routerLocation, breadcrumbNameMap, props), itemRender);
        return {
